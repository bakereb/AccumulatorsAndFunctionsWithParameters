...
def run_test_fancy_sums_of_digits():
    ...
    # Test 3:
    expected = 93268
    answer = fancy_sums_of_digits(17)
    print('Test 1 expected:', expected)
    print('       actual:', answer)
